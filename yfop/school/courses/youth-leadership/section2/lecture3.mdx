---
title: MODULE 17 - PROJECT DEVELOPMENT TOOLS
number: 3
video: ZKW2GTCn3D4
---
...
- Check Ashoka's Systems Change Crash Course.
- Practical tools for International Development by Tool4dev.
- Social Impact Measurement Tools by SOCAP.
- A playbook for designing impact measurement by Stanford Social Innovation Review.
- 6 Social Media Tools for online fundraising. 
- Nonprofit Fundraising Essentials developed by Acumen. 
- Watch this inspiring video '48 ideas for fundraising by Whole whale'. 
- Check out Network for Good’s Virtual Fundraising Toolkit.
- GlobalGiving provides local organizations the tools,      training, and support they need to thrive. This nonprofit that supports other nonprofits by connecting them to donors and companies.
- Measuring your social impact: Example from Community food projects.
...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Module-17_-Project-Development-Tools.pdf'" type="button">
