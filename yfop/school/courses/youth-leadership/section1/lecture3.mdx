---
title: MODULE 15 - ENVIRONMENTAL ACTIVISM
number: 3
video: 7pFcn4p8egA
---
...
- Join the upcoming online Climate Reality Leadership Corps Training to become a Climate Leader and help spread the science behind it.
- Join the Earth Day Network and take action in the causes that appeal the most to you.
- Check out these tools for activists from the Activist Handbook to improve your communication.
- Check out the Stand Up for Nature Action Plan Handbook, by WWF, GYAT and GYBN.
- Visit dothegreenthing.com and explore the funny and educational communications they’ve developed.
- Watch The Success of Nonviolent Civil Resistance by Erica Chenoweth 
-Visit change.org to see what causes you can support by sharing information, signing petitions and even donating! 
...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Module-15_-Environmental-Activism-Advocacy-Campaigning.pdf'" type="button">
