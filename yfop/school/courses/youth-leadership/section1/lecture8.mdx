...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/FR-Worksheet-Module-17.pdf'" type="button">
         Download Worksheet - French</button> <br />
         
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Modulo-17.pdf'" type="button">
