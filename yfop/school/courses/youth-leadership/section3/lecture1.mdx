...
- Beyond Reason: Using Emotions as you Negotitate     A universally applicable method for effectively negotiating personal and professional disputes. 
- Negotiating the Nonnegotiable: How to Resolve Your Most Emotionally Charged Conflicts a groundbreaking method to bridge the toughest divides
- THINK OR SINK: Leading in a Vuca World by Lee G. Bolman and Terrence E. Deal
...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Module-5_-Community-Sustainability-Leadership.pdf'" type="button">
