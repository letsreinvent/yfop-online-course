...
### OPTIONAL MATERIALS
- What is Regeneration? an explanation of the concept by different voices made by Re-Alliance
- Natural Capitalism book by Paul Hawken et al
- Presentation and panel about Regenerative Development featured at Low Carbon City’s World Forum
- The blog Beyond sustainability by writer Daniel Christian Wahl is an amazing source to learn regenerative development
- The LUSH Spring prize awards organisations with £200.000 working to revive damaged social and natural environments.
...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Module-12_-Regenerative-Development.pdf'" type="button">
