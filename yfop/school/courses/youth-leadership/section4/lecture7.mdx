...
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Module-14_-Citizen-led-Solutions_-What-can-we-do_.pdf'" type="button">
         Download Worksheet - English</button> <br />

<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/FR-Worksheet-Module-14.pdf'" type="button">
         Download Worksheet - French</button> <br />
         
<button onclick="location.href='https://letsreinvent.org/wp-content/uploads/2021/03/Modulo-14.pdf'" type="button">
